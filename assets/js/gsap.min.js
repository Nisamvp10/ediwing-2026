...
!(function (t, e) {
    ...
    function Ca(t, e, r, i) {
        return (
            t._startAt &&
            (B ? t._startAt.revert(ht) : (t.vars.immediateRender && !t.vars.autoRevert) || t._startAt.render(e, !0, i))
        );
    }
    function Ea(t) {
    ...
    function Ja(t, e) {
        ...
        if (
            ((e._time || (e._initted && !e._dur)) &&
                ((r = Ga(t.rawTime(), e)), (!e._dur || kt(0, e.totalDuration(), r) - e._tTime > V) && e.render(r, !0)),
    ...
    function Ma(t, e, r, i, n) {
        return (
            Ht(t, e, n),
            t._initted
                ? !r && t._pt && !B && ((t._dur && !1 !== t.vars.lazy) || (!t._dur && t.vars.lazy)) && f !== Et.frame
        ...
        Xt = function _addPropTween(t, e, i, n, a, o, u, h, l, f) {
            ...
            if (
                ...
                return isNaN(p * n) || "" === n
                    ...
                    : ((c = new pe(this._pt, t, e, +p || 0, n - (p || 0), "boolean" == typeof d ? ae : ne, 0, _)),
                      l && (c.fp = l),
                    ...
                    if ($(x))
                        ...
                        for (l in u)
                            for (
                                ...
                                ((D = { ease: (S = A[o]).e, duration: ((S.t - (o ? A[o - 1].t : 0)) / 100) * _ })[l] =
                                    S.v),
                                    s.to(C, D, E),
                                    (E += D.duration);
    ...
    function Hd(t, e) {
        ...
        if (t in rr) {
            if (
                ...
                return;
            i._gsap.webp && ((this.webpo = i.getAttribute("data-svg-origin")), this.props.push(fr, e, "")), (t = lr);
        }
    ...
    function Jd() {
        ...
        if (this.tfm) {
            ...
            a.webp && (a.renderTransform(), i.setAttribute("data-svg-origin", this.webpo || "")),
    ...
    function Td(e) {
        ...
        return (
            ...
            !r || r.width || r.x || r.y
                ? r
                : { x: +Sd(e, ["x", "cx", "x1"]) || 0, y: +Sd(e, ["y", "cy", "y1"]) || 0, width: 0, height: 0 }
        );
    }
    function Ud(t) {
    ...
    function ce(t, e) {
        if (e.tween && e.tween._time === e.tween._dur) {
            ...
            i && (Vd(a, lr), u && (u.webp && a.removeAttribute("transform"), br(a, 1), (u.uncache = 1), Id(s)));
        }
    }
    function ge(t) {
    ...
    function ie(t, e) {
        var r,
            ...
            o = t.style,
            u = he(t);
        return s.webp && t.getAttribute("transform")
            ? "1,0,0,1,0,0" ===
    ...
    var Ae,
        ...
        mr = function _get(t, e, r, i) {
            ...
            return (
                ...
                rr[e] && "transform" !== e
                    ? ((n = br(t, i)),
                      (n = "transformOrigin" !== e ? n[e] : n.webp ? n.origin : wr(Nd(t, fr)) + " " + n.zOrigin + "px"))
        ...
        br = function _parseTransform(t, e) {
            ...
            return (
                ...
                m !== yr &&
                    ...
                    6 === m.length
                        ? ((s = Math.sqrt(T * T + b * b)),
                          ...
                          r.webp && ((i -= p - (p * T + _ * w)), (n -= _ - (p * b + _ * x))))
                        : ((z = m[6]),
                          (D = m[7]),
                          (A = m[8]),
                          (S = m[9]),
                ...
                (r.force3D = j.force3D),
                (r.renderTransform = r.webp ? Cr : Ie ? Pr : xr),
                (r.uncache = 0),
                r
            );
        },
